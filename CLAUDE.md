...
- **Five tools**, not one per resource: `netbox_global_search`, `netbox_discover`, `netbox_describe`, `netbox_read`, `netbox_write`. Object types are derived at runtime from the instance's own OpenAPI schema.
